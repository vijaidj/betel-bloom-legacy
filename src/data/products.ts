...
export const products: Product[] = [
  ...
  },
  {
    ...
    journey: defaultJourney,
    compareRows: ["Price", "Net weight", "Servings", "Best for", "Value", "Shelf life"],
    variants: [
      {
        id: "50g",
        label: "50\u00A0g",
        ...
        whyThis: [
          ...
          "Same leaf, same grind, same price per gram",
        ],
        compare: {
          Price: "₹300 (MRP ₹350)",
          "Net weight": "50\u00A0g",
      ...
      },
      {
        ...
        whyThis: [
          ...
          "Same price per gram as the pouch, half as many reorders",
